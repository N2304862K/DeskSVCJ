...
cdef extern from "svcj.h":
    ...
    void update_swarm(Particle* swarm, PhysicsParams* phys, 
                      ...
                      double ctx_drift, double ctx_conf,
...
cdef class IntradaySwarm:
    ...
    def update_tick(self, double o, double h, double l, double c, double v_ratio, double d_factor, double ctx_drift, double ctx_conf):
        cdef SwarmState out
        with nogil:
            update_swarm(self.swarm, &self.phys, o, h, l, c, 
                         v_ratio, d_factor, self.dt_base, 
                         ctx_drift, ctx_conf, &out)
